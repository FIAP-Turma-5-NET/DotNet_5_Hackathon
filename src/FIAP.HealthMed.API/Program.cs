...
{
    throw new InvalidOperationException("A chave 'SecretJWT' n�o foi encontrada ou est� vazia no arquivo de configura��o.");
}
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "API para gerenciamento de consultas m�dicas e usu�rios"
    });
